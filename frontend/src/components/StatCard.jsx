...
export default function StatCard({ 
  ...
  return (
    <motion.div 
      variants={cardItem} 
      whileHover={{ y: -5 }} 
      className={`${backgroundColor} ${darkBgColor} rounded-2xl p-6 shadow-lg dark:shadow-none border ${borderColor} ${darkBorderColor} dark:neon-border-brand transition-all duration-300 relative overflow-hidden group scanline`}
    >
      ...
      <div className="flex items-baseline gap-2 mb-2">
        <h2 className={`text-4xl font-black ${textColor} ${darkTextColor} transition-colors tracking-tighter dark:neon-text-brand`}>
